...
if ( ! function_exists( 'universal_openid4vp_session_bootstrap' ) ) {
...
if ( ! function_exists( 'universal_openid4vp_session_token' ) ) {
...
if ( ! function_exists( 'universal_openid4vp_session_key' ) ) {
...
if ( ! function_exists( 'universal_openid4vp_session_get_all' ) ) {
...
if ( ! function_exists( 'universal_openid4vp_session_get' ) ) {
...
if ( ! function_exists( 'universal_openid4vp_session_set' ) ) {
...
if ( ! function_exists( 'universal_openid4vp_session_delete' ) ) {
